...
The <ExternalLink href="https://hasura.io/learn/graphql/typescript-react-apollo/codegen/">
Hasura's official tutorial</ExternalLink> provides a settings code block which I modified some "special configurations" in it (with the ⛑️ indicator):
...
This is a note from me about developing an application with Next.js and Hasura. The app is called <ExternalLink href="https://ddd.cyishere.dev">DDD App</ExternalLink>, and it is a tool for remembering German nouns. You can learn more about it [here](/blog/ddd-app-a-neat-tool-for-remembering-german-nouns).
