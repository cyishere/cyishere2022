...
export const projects = [
  {
    ...
    description: `"digiKIT" is a fake e-commerce web app to demonstrate how this kind of app works on both server-side and client-side.`,
    imageUrl: "/img/portfolio/digikit/digikit-cover_s.jpg",
  },
  {
    id: "2",
    name: "Chat App",
    href: "/portfolio/chat-app",
    description: `I am fascinated by the concept of GraphQL and Prisma, so I made a chat app to learn the subscription of GraphQL, to know Prisma better. I used TailwindCSS for fast development.`,
    imageUrl: "/img/portfolio/chat-app/chat-app-cover_s.jpg",
  },
  {
    id: "3",
